...
import net.silthus.regions.util.ProtocolUtils;
...
// copied from: https://github.com/blablubbabc/IndividualSigns
public class SignPacketListener implements Listener {

    private final RegionsPlugin plugin;
    private final ProtocolManager protocolManager;

    public SignPacketListener(RegionsPlugin plugin, ProtocolManager protocolManager) {
        this.plugin = plugin;
        this.protocolManager = protocolManager;

        registerEntityDataListener();
        registerMapChunkDataListener();
    }

    private void registerEntityDataListener() {
    ...
    private void registerMapChunkDataListener() {
    ...
    void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (event.getAction() == Action.RIGHT_CLICK_BLOCK && event.getClickedBlock() != null) {
            ...
            if (SignUtils.isSign(blockType)) {
                // send sign update:
                Player player = event.getPlayer();
                Sign sign = (Sign) block.getState();
                player.sendSignChange(sign.getLocation(), sign.getLines(), SignUtils.getSignTextColor(sign));
            }
        }
    }
